...
// 获取着色器文本 (glsl es语言) 
const vsSource = document.querySelector('#rotateVertexShader').textContent
const fsSource = document.querySelector('#rotateFragmentShader').textContent
...
const rotate = (gl) => {
    ...
    requestAnimationFrame(() => rotate(gl))
}
